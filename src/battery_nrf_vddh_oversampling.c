 ...
 *
 * External variant of ZMK's battery_nrf_vddh.c. It keeps the original behavior
 * but makes adc_sequence.oversampling configurable from Kconfig.
 */

#define DT_DRV_COMPAT te9no_battery_nrf_vddh_oversampling
...
static int vddh_init(const struct device *dev) {
    ...
    drv_data->as = (struct adc_sequence){
        ...
        .oversampling = CONFIG_ZMK_BATTERY_NRF_VDDH_OVERSAMPLING_VALUE,
        .calibrate = true,
    };
